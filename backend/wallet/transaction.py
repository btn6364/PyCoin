...
class Transaction:
    ...
    def create_input(self, sender_wallet, output):
        ...
        Sign the transaction and include the sender's public key and add address.
        """
        return {
    ...
    def from_json(transaction_json):
        """ 
        Deserialized a transaction's json representation back into a Transaction instance. 
        """
        # return Transaction(
...
def main():
    ...
    print(f"\n\n Restored_transaction dict: {restored_transaction.__dict__}")
