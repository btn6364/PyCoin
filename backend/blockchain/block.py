...
class Block:
    ...
    def from_json(block_json):
        """
        Deserialize a block's json representtation back into a block instance
        """
    ...
    def adjust_difficulty(last_block, new_timestamp):
        ...
        Increase diff for quickly mined blocks.
        Decrease diff otherwise.
        """
    ...
    def is_valid_block(last_block, block):
        ...
        - the block must meet the PoW requirement. (hash with same amount of difficulty 0) 
